...
<form action="<?= url("/")?>" method="post">
    ...
    <div class="flex flex-col md:flex-row w-full h-auto md:h-[600px] max-w-4xl bg-white rounded-tl-[100px] rounded-tr-[20px] rounded-br-[100px] rounded-bl-[20px] shadow-lg overflow-hidden m-5">
        ...
        <div class="md:w-1/2 p-10 flex flex-col justify-center">
            ...
            <input name="senha" placeholder="Sua senha..." class="w-full p-2 border border-gray-300 rounded mt-4 focus:outline-none focus:ring-2 focus:ring-blue-600">
        <button type="submit" class="w-full bg-blue-600 text-white font-semibold py-2 rounded mt-4 hover:bg-blue-700 transition">
            ENTRAR
        </button>
    </div>
</form>