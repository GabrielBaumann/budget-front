...
<head>
    ...
    <link rel="stylesheet" href="<?= themes("/app/assets/styles_index.css")?>">
    <?= $this->section('style')?>
</head>
<body class="bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 flex flex-col min-h-screen font-sans transition-colors duration-200 pb-16 sm:pb-0">
    ...
    <header class="h-16 border-b border-gray-200 dark:border-gray-600 px-4 sm:px-6 flex items-center justify-center sticky top-0 bg-white dark:bg-gray-800 z-10">
        <div class="flex items-center space-x-2 mx-auto">
            ...
            <h1 class="text-lg font-semibold">OrçaFácil</h1>
        </div>

        <button id="theme-toggle" class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors absolute right-4">
    ...
    <!-- Segundo Header com Abas de Navegação -->
        ...
        <nav class="flex items-center justify-center h-full">
            <div class="flex items-stretch h-full max-w-4xl w-full">
                ...
                <a href="<?= url("/unidade"); ?>" class="flex items-center justify-center px-4 sm:px-6 relative hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex-1">
                    <span class="text-xs sm:text-sm">Unidades de medidas</span>
                </a>
                <a href="orcamentos.html" class="flex items-center justify-center px-4 sm:px-6 relative hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex-1">
                    <span class="text-xs sm:text-sm">Categoria de Materiais</span>
                </a>
                <a href="relatorios.html" class="flex items-center justify-center px-4 sm:px-6 relative hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex-1">
...
<nav class="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-600 flex sm:hidden z-20">
    <a href="index.html" class="flex flex-col items-center justify-center py-2 px-4 flex-grow text-primary-600 dark:text-blue-400 font-medium relative active-tab">
...
<script src="<?= themes("/app/assets/script.js"); ?>"></script>
<script src="<?= themes("/app/assets/jquery.form.js"); ?>"></script>
</body>
</html>